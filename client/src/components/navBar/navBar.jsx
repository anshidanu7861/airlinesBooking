...
const navigation = [
  ...
  { name: 'Your Bookings', href: '/viewAllbookings', current: false },
...
export default function NavBar() {
  ...
  return (
    <Disclosure as="nav" className="bg-gradient-to-l from-white  to-gray-400">
      {({ open }) => (
        <>
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? ' text-black' : 'text-black hover:bg-gray-700 ',
                ...
                <Menu as="div" className="relative ml-3">
                  <div>
                    <Menu.Button className="flex  text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      ...
                      <p className='text-black h-8 w-8'>{user.fname}</p>
                    </Menu.Button>
                  </div>
                  <Transition
                    as={Fragment}
